...
// Regex to match Vercel's preview deployment URLs (e.g., mindgpt-ai-*.vercel.app)
const vercelPreviewRegex = /^https:\/\/mindgpt-ai-.*\.vercel\.app$/;

const corsOptions = {
    origin: (origin, callback) => {
        // Allow requests from the whitelist, Vercel preview URLs, or with no origin (e.g., Postman)
